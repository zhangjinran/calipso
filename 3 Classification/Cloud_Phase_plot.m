function  Cloud_Phase_plot(block,lims,type,lat,figureNum,fileTime1)
...
set(gcf,'unit','centimeters','position',[2 2 80 15]);
...
elseif strcmp(type,'Aerosol')
    ...
    FigureName=strcat('Aerosol Classification',':',fileTime1);
    disp(FigureName)
    title(FigureName,'FontSize',fontsize,'fontweight','bold')
    text('Units','normalized','Position',[0.10,-0.28],'String',TypeText,...
        'color','k','FontWeight','bold','fontsize',fontsize-2,'EdgeColor','k')%设置单位为像素
elseif strcmp(type,'CAD')
