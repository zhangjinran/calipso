function Fun_Layer_Plot(Lat,Lidar_Data_Altitudes,TAB_532,topbin_under80km,basebin_under80km)
...
%%
myfontsize=16;hori=0.08;verti=0.08;
clim = ([-5e-3,1e-1]/3);
figure('color','w','unit','normalized','position',[0.1,0.1,0.73,0.45])
clf;
posi=[0.06,0.14,0.41,0.78];
