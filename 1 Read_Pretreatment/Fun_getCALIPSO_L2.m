...
if contains(filename,'05kmALay') 
    ...
    % 方法一：读取 Profile_UTC_Time（字符串格式，直接给出绝对日期）
% 注意：Level 2 产品中时间字段可能存储在 metadata 中
% 读取 Profile_UTC_Time（字符串）
    ...
    'Lidar_Data_Altitudes');
        ...
        output_CALIPSO_L2_data.lidar_Data_Altitude=Lidar_Data_Altitudes;
