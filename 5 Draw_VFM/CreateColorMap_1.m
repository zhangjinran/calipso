...
%        float Dhue,Dsat,Dval;
  ...
  if nargin == 1,
    ColorMap = 'default';
     ...
     if (NumColors == 8),
         if strcmp(ColorMap,'Tropospheric Aerosol Sub-Type') | strcmp(ColorMap,'Aerosol Sub-Type (Truth)'), 
	   red = [255   0   0 144 255 255 192 255 ]'/255;
	   grn = [ 255   0 255 255 255 159 192 0 ]'/255; 
	   blu = [ 255 144 255 111   0   0 192 0 ]'/255; 
         elseif strcmp(ColorMap,'Cloud Sub-Type') | strcmp(ColorMap,'Cloud Sub-Type (Truth)'),
	   red = [  0   0   0 144 255 255 192 255 ]'/255;
	   grn = [  0   0 255 255 255 159 192 255   ]'/255; 
	   blu = [  0 144 255 111   0   0 192 255 ]'/255; 
    ...
    elseif (NumColors == 9),
	   ...
	   red = [255   0   0 128 144 255 255 192 255 ]'/255;
	   grn = [  0   0 255   0 255 255 159 192 255 ]'/255; 
	   blu = [  0 144 255 128 111   0   0 192 255 ]'/255; 
       end
       return;
    elseif (NumColors == 6),
       ...
       return;
    elseif (NumColors == 5),
       red = [ 230 0 230 255    0 ]'/255;
       grn = [ 230 0   0  255 200  ]'/255;
       blu = [ 230 0   0   0    0 ]'/255; 
       return;
    elseif (NumColors == 4),
       red = [ 255 0 255    127 ]'/255;
       grn = [ 255 191  127 255 ]'/255;
       blu = [ 255 255  0    0 ]'/255; 
       return;
