function [block,TypeText] = vfm_plot_V1_1_legacy(vfm,lims,type,lat,noplot)
% �޸İ棨�ٷ����������⣩
...
%     x = lims(1)*15*333/1000 + 333*temp/1000; % distance in km
    ...
    clf;
    set(gcf,'color','w');               % gcf ���ص�ǰFigure ����ľ��ֵ,��ͼ����Ϊ��ɫ
